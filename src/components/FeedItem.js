...
import { LikeIcon, ReplyIcon, ReTweetIcon, ShareIcon } from "../assets/icons/icon";

const FeedItem = ({ avatar, content, displayName, timestamp, username }) => {
  return (
    <article className="flex space-x-3 border-b border-x-gray-extraLight px-4 py-3 cursor-pointer">
      ...
      <div className="flex-1">
        <div className="flex items-center text-sm">
          ...
          <div className="mx-2 bg-gray-dark h-1 w-1 border roundend-full" />
        ...
        <ul className="flex justify-between max-w-md md:-ml-1 mt-3">
            ...
            <li className="group flex items-center space-x-3 text-gray-dark text-sm">
                <div className="flex items-center justify-center w-8 h-8 rounded-full group-hover:bg-green-200">
                    <ReTweetIcon className="w-5 h-5 hover:text-green-400" />
                </div>
            ...
            <li className="group flex items-center space-x-3 text-gray-dark text-sm">
                <div className="flex items-center justify-center w-8 h-8 rounded-full group-hover:bg-pink-200">
                    <LikeIcon className="w-5 h-5 hover:text-pink-400" /> 
                </div>
            ...
            <li className="group flex items-center space-x-3 text-gray-dark text-sm">
                <div className="flex items-center justify-center w-8 h-8 rounded-full group-hover:bg-primary-light">
                    <ShareIcon className="w-5 h-5 hover:text-primary-base" />
                </div>
            </li>
        </ul>
      </div>
